      ...
      <section className="py-16 bg-background">
        <div className="container mx-auto px-4 md:px-6 max-w-3xl prose prose-stone">
          ...
          >
            ...
            <p>
              <strong>Betriebsadresse / Restaurant:</strong><br />
              Hafenweg 8<br />
              48155 Münster
            </p>
            ...
            <p>
              ...
              E-Mail: <a href="mailto:info@hochstapler-burger.de">info@hochstapler-burger.de</a><br />
              Website: <a href="https://hochstapler-burger.de" target="_blank" rel="noopener noreferrer">www.hochstapler-burger.de</a>
            </p>

            <h2>Umsatzsteuer-ID</h2>
            <p>
              Umsatzsteuer-Identifikationsnummer gemäß § 27a Umsatzsteuergesetz:<br />
              <strong className="text-coral">[Bitte USt-IdNr. eintragen — z.B. DE123456789]</strong>
            </p>

            <h2>Verantwortlich für den Inhalt nach § 18 Abs. 2 MStV</h2>
            <p>
              Franz-Ludwig Feldhaus<br />
              Egbert-Snoek-Straße 1<br />
              48155 Münster
            </p>
